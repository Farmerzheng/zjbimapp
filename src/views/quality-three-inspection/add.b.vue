  ...
  <div class="nav-header">
    ...
    <ali-collapse :title="comment.activityName">
      <ali-select
        ...
        @get-selection="
          (item) =>
            (form['qualityThreeInspectionComment.nextPerson'] =
              item.phonenumber)
        "
        required
        readonly
  ...
  setup(props) {
    ...
    const state = reactive({
      ...
      form: {
        ...
        startDate: '',
        endDate: '',
        'qualityThreeInspectionComment.guid': '',
        'qualityThreeInspectionComment.activityName': '',
        'qualityThreeInspectionComment.activityCode': '',
        'qualityThreeInspectionComment.msg': '',
        'qualityThreeInspectionComment.nextPerson': '',
        'qualityThreeInspectionComment.nextPersonName': '',
        'qualityThreeInspectionComment.hopeToDate': '',
      },
      fileList: [],
      fileUrls: [],
      comment: {
